...
#         self.colorsl = self.convert2list()
#         self.check_inputs()
...
#         # return self.colors
#
#     def rampligtness(self, amt, dir=0):
#         if dir == 0 or dir == 1:
...
class LVL2:
    ...
    def sin_avg_point_rotation(strands=20, xshift=10, yshift=0,
                               ...
                               position=[0, 0], showpoint=False, draworig=False):
        funclist = []
        xpos, ypos = position[0], position[1]
