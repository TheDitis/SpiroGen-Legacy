...
rainbow1 = ColorScheme(rainbow, 50)
...
# tt1 = TimesTable(300, 200, 20, 200, color=rainbow1, rotation=0)
# tt1.draw()
...
# DrawPath(wvs, colors=rainbow1[20:], colordist=20, colorsync=True, pensize=(1, 20))
