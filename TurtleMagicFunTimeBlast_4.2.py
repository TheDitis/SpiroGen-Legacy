...
class LVL2:
    ...
    def sin_avg_point_rotation(strands=20, xshift=10, yshift=0,
                               ...
                               ampshift=0, length=25, cosine=False,
        ...
        print(len(funclist), len(funclist[0]))
        center = Analyze(funclist, ldepth=get_depth(funclist)).center()
...
rainbow1 = ColorScheme(rainbow, 160)
...
wvs = LVL2.sin_avg_point_rotation(20, 2, 0, 2, 2, length=25, draworig=False, )
# wvs = LVL2.sin_spiral(20, 5, 0, 1, cosine=False, length=25)
...
# tt1 = TimesTable(300, 200, 2, 200, color='white', yscale=0.5, rotation=45)
